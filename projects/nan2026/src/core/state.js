...
function recomputeTraitFx(world) {
 ...
 *   즉 아래 네 스포너 전부). 난이도는 이제 «배속·점수»만이 아니라 «적이 얼마나 단단한가»를 정한다.
 *   ★ 기준선은 «가장 어려운 난이도»다(hell.hpMul == 1) — 저작값이 곧 헬이고 쉬운 난이도는 그 할인이다.
 *     만드는 사람이 조율하는 자리가 곧 헬이 되도록(§11.3 · S60 ②).
