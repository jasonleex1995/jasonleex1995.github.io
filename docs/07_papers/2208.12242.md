...
### 2.3. Class-specific priot preservation loss
...
Authors generate about 1,000 images with text prompt `a [class noun]` for class-specific prior preservation loss.  
